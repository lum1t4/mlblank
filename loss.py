...
from mlblank.core.ops import xywh2xyxy
from mlblank.core.metrics import bbox_iou, probiou
from mlblank.core.ops import xywhr2xyxyxyxy
from mlblank.model.yolov8 import dist2bbox, bbox2dist, make_anchors
...
class TaskAlignedAssigner(nn.Module):
    ...
    Attributes:
        topk: The number of top candidates to consider.
        num_classes: The number of object classes.
        alpha: The alpha parameter for the classification component of the task-aligned metric.
        beta: The beta parameter for the localization component of the task-aligned metric.
...
class v8DetectionLoss:
    """
    Computes the loss for YOLOv8 object detection models.

    This class calculates the combined loss for bounding box regression, 
    objectness score, and classification, considering DFL (Distribution 
    Focal Loss) if applicable.
    """
    ...
    def __init__(
        ...
        """
        Initializes the loss function with the model and hyperparameters.

        Args:
            model (nn.Module): The YOLOv8 model.
        ...
        self.device = device
        self.nc = nc
        self.reg_max = reg_max  # Maximum number of distribution bins
        self.stride = torch.tensor(stride, device=device, dtype=torch.float32)
    ...
    def __call__(self, preds: torch.Tensor, targets: torch.Tensor):
        ...
        loss[0] *= self.bbox_gain  # box gain
